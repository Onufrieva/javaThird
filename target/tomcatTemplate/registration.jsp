        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index">registration</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <form action="${pageContext.request.contextPath}/servlet/registration" method="post" align="center">
                        ...
                        <div class="form-group">
                            <label for="login">INPUT_LOGIN</label>
                            <input type="login" class="form-control" id="login" name="login">
                        </div>

                        <div class="form-group">
                            <label for="pass">INPUT_PASSWORD </label>
                            <input type="password" class="form-control" id="pass" name="pass">
                        </div>

                        <div class="form-group">
                            <label for="confirm">page.reg.confirm_pass </label>
