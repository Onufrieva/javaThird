...
//
        commandMap.put("/gotonewfilm", new GoToNewFilmCommand());
        commandMap.put("/newfilm", new NewFilmCommand());
//
//        commandMap.put("/gotonewschedule", new GoToNewExhibitionCommand());
//        commandMap.put("/newschedule", new NewExhibitionCommand());
//
